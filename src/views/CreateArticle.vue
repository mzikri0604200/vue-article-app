...
const createArticleMutation = useMutation({
	mutationFn: async () => {
		const articlePayload = {
			...
			tagList: [...articleData.article.tagList] // Create a new array to ensure reactivity
		}

		await CustomApi.post('/articles', { article: articlePayload }, {
			headers: {
...
<template>
	<form @submit.prevent="handleSubmit">
		<fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-4">
			<legend class="fieldset-legend">Create Article</legend>
